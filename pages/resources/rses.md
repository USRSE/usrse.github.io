...
- [USRSE'25](https://zenodo.org/communities/usrse25/records?q=&l=list&p=1&s=10&sort=newest)
- [USRSE'24](https://zenodo.org/communities/usrse24/records?q=&l=list&p=1&s=10&sort=newest)
- [USRSE'23](https://zenodo.org/communities/usrse23/records?q=&l=list&p=1&s=10&sort=newest)
- [Research Software Engineering – Software-Enabled Discovery and Beyond](https://www.sciencedirect.com/special-issue/10GXQ2MQKBW): special issue of *Future Generation Computer Systems* journal with extended papers from USRSE'23
...
See the [Related Organizations resource page]({{ site.baseurl }}/resources/organizations/relevant/ ) for links to additional useful resources by other organizations related to Research Software Engineering.
