...
The Steering Committee has also been discussing the move to our new fiscal sponsor, [Community Initiatives](https://us-rse.org/2023-03-21-announcing-ci/), and continuing planning for the 2023 US-RSE Conference. Conference planning has included discussion of potential costs and financial liabilities, such as hotel room blocks. Other topics have included how to keep track of significant organizational developments to track our history, managing permissions for organizational resources, fundraising and US-RSE merchandise, and how to handle requests from external groups for time on [community calls](https://us-rse.org/events/#community-call).
