---
layout: post
title: "A. Philip Randolph, The Brotherhood of Sleeping Car Porters, and the Invisible Labor of Research Software Engineers"
...
![A. Phillip Randolph in front of the Lincoln Memorial]({{ site.baseurl
}}/assets/img/bhm-2025-randolph.png "A. Phillip Randolph"){: style="display:
block; margin: auto; max-width: 600px;" }
...
"Photo of two rows of railroad workers"){: style="display: block; margin: auto;
max-width: 600px;" }
...
Future, Black History Month"){: style="display: block; margin: auto; max-width:
600px;" }
